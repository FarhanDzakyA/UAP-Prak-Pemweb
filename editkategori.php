<?php
  ...
  $query_select = mysqli_query($mysqli, "SELECT * FROM `kategori` WHERE `id_kategori` = '$_GET[update]'");
                    ...
                    <div class="card-body">
                        <form action="" method="POST">
                            <div class="form-group w-50">
                                <label for="nama_kategori">Kategori Menu <i class="fas fa-star-of-life" style="font-size: 7px; vertical-align: top; color: #ED2939"></i></label>
                                <input type="text" class="form-control" id="nama_kategori" name="nama_kategori" value="<?= $result['nama_kategori']; ?>" required>
                            </div>
                        ...
                        <?php 
                            if(isset($_POST['btn-simpan'])) {
                                ...
                                $query_update = mysqli_query($mysqli, "UPDATE `kategori` SET `nama_kategori`='$nama_kategori' WHERE `id_kategori` = '$id_kategori'");
                                ...
                                if($query_update) {
                                    ...
                                    <script>
                                        Swal.fire({
                                            title: "Berhasil!",
                                            text: "Data kategori menu berhasil diubah!",
                                            icon: "success"
                                        }).then(function() {
