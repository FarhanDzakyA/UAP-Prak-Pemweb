                        ...
                        <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                          ...
                          <tbody>
                            <?php while($result = mysqli_fetch_assoc($query_table)) { ?>
                              ...
                              <div class="modal fade" id="hapusMenu<?= $result['id_menu'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<?php
  if(isset($_POST['btn-hapus'])) {
    ...
    $query_delete = mysqli_query($mysqli, "DELETE FROM `menu` WHERE `id_menu` = '$id_menu'");
