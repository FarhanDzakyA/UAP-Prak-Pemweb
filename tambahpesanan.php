...
<head>
    ...
    <title>Ragam Rasa - Tambah Pesanan</title>
            ...
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="nav-link d-flex align-items-center" href="tambahpesanan.php">
                            <i class="fas fa-fw fa-plus mr-2" style="color: #6e707e"></i>
                            <h1 class="h4 mb-0 text-gray-700 font-weight-bold">Tambah Pesanan</h1>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-4 mb-2">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" name="menu[]" id="menu<?= $menu['id_menu'] ?>" value="<?= $menu['id_menu'] ?>" data-price="<?= $menu['harga'] ?>">
                                ...
                                <div class="col-3 border-left border-secondary">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="datetime-local" class="form-control" id="waktu" name="waktu" value="<?= date('Y-m-d\TH:i') ?>" readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-lg" id="totalHarga" name="totalHarga" value="Rp 0" readonly>
                                    </div>
                        ...
                        <?php
                            if(isset($_POST['btn-simpan'])) {
                                ...
                                $query_pesanan = mysqli_query($mysqli, "INSERT INTO `pesanan`
                                (`waktu_pesanan`, `keterangan`, `total_harga`) 
                                VALUES ('$waktu','$keterangan','$totalHarga')");

                                if($query_pesanan) {
                                    $last_id = mysqli_insert_id($mysqli);

                                    foreach($menu as $item) {
                                        $query_detail_pesanan = mysqli_query($mysqli, "INSERT INTO `detail_pesanan`
                                        (`id_pesanan`, `id_menu`) VALUES ('$last_id','$item')");
                                    }
