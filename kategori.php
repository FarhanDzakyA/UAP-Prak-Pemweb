                  ...
                  <div class="card shadow mb-4">
                    <div class="card-header py-3">
                      <div class="d-sm-flex align-items-center justify-content-between">
                        ...
                        <a href="tambahkategori.php" class="d-none d-sm-inline-block btn btn-sm btn-primary rounded-pill shadow-sm">
                          ...
                          <tbody>
                            <?php while($result = mysqli_fetch_assoc($query_table)) { ?>
                              <tr>
                                ...
                                <td class="col-aksi">
                                  <a href="editkategori.php?update=<?= $result['id_kategori']; ?>" class="btn btn-primary btn-circle btn-sm">
                                    <i class="fa-solid fa-fw fa-pen"></i>
                                  </a>
                                  <span class="mr-2"></span>
                                  <a href="#" class="btn btn-danger btn-circle btn-sm" data-toggle="modal" data-target="#hapusKategori<?= $result['id_kategori'] ?>">
                                  ...
                                  <div class="modal-content">
                                    ...
                                    <form action="" method="POST">
                                      ...
                                      <div class="modal-body">
                                        Apakah Anda yakin ingin menghapus kategori <?= $result['nama_kategori'] ?> ?
                                      </div>
