...
<head>
    ...
    <title>Ragam Rasa - Tambah Kategori</title>
            ...
            <div id="content">
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <a class="nav-link d-flex align-items-center" href="tambahkategori.php">
                            <i class="fas fa-fw fa-plus mr-2" style="color: #6e707e"></i>
                            <h1 class="h4 mb-0 text-gray-700 font-weight-bold">Tambah Kategori</h1>
                        </a>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <?php 
                            if(isset($_POST['btn-simpan'])) {
                                ...
                                $query_insert = mysqli_query($mysqli, "INSERT INTO `kategori`(`nama_kategori`) VALUES ('$nama_kategori')");
                                ...
                                if($query_insert) {
                                    ...
                                    <script>
                                        Swal.fire({
                                            title: "Berhasil!",
                                            text: "Data kategori menu berhasil ditambahkan!",
                                            icon: "success"
                                        }).then(function() {
